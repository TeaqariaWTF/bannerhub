...
**FEATURE COMPLETE.** NEXT: merge `voice-chat` → main + cut a 3.7.x release (build.yml, full 9-variant). Optional follow-ups: name prompt on the browser share-link page; v6 rosterNames adoption.
